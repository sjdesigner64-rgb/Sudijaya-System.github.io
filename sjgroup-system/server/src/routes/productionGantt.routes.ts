...
router.get('/:ganttId/tasks', async (req, res) => {
...
router.post('/:ganttId/tasks', async (req, res) => {
...
router.put('/:ganttId/tasks/:taskId', async (req, res) => {
...
router.delete('/:ganttId/tasks/:taskId', async (req, res) => {
