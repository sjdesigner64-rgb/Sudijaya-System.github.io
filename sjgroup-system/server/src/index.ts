...
app.use('/api/requests_drawing', createCrudRouter(prisma.drawingRequest, 'requests_drawing'))
...
app.use('/api/after_sales', createCrudRouter(prisma.afterSales, 'after_sales'))
